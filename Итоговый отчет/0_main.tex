...
\lstdefinestyle{mystyle}{
    ...
    basicstyle=\rmfamily\small,           % Times New Roman вместо \ttfamily
    keywordstyle=\color{blue}\bfseries,
    commentstyle=\color[HTML]{2B8315}\itshape,
    ...
    keepspaces=true,
    extendedchars=true,
    captionpos=b,                          % Теперь подпись сверху для memoir
    abovecaptionskip=10pt,                 % Отступ над кодом
    belowcaptionskip=0pt                   % Отступ под подписью
}

\lstset{style=mystyle}

\input{1_chap1}                                     % Введение
% \input{2_chap2}                                     % Первая глава
